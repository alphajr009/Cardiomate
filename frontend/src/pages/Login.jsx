...
export default function Login() {
  return (
    ...
    <span className='heading'>Hello! Welcome Back!</span>
    ...
    <Button className='Login' type="primary" style={{background: '#000000',width: '200px',height: '40px',borderRadius: '10px',fontFamily: 'Arial',fontStyle: 'normal',fontWeight: '300',fontSize: '13px',marginTop: '359px' ,left: '73px' }}>Login</Button>
    </div>
    </div>
  )
}